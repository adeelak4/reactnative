...
const Login = () => {
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <Text style={styles.mainDescrption}>Welcome to our brand new application hope you enjoy alot</Text>
      ...
      <View style={styles.wrapper}>
        <Checkbox value={agree} onValueChange={() => setAgree(!agree)} color={agree ? "green" : undefined} />
        <Text style={styles.wrapperText}>{"  "}I have read and agreed with Term and Condition</Text>
      </View>
